"""
Sistema de Recomendación de Agentes CrewAI
Integra agentes especializados para generar recomendaciones dinámicas basadas en KPIs
"""
...
class AgentRecommendationSystem:
    ...
    def execute_agent_recommendations(self, recommendations: List[AgentRecommendation], 
        ...
        for recommendation in recommendations[:3]:  # Ejecutar solo los 3 más prioritarios
            try:
...
def main():
    ...
    print("🤖 Sistema de Recomendación de Agentes CrewAI")
    print("=" * 50)
