"""
Procesador Mejorado con Integración de Agentes CrewAI
Combina análisis de KPIs con recomendaciones y ejecución de agentes especializados
"""
...
from agent_recommendation_system import AgentRecommendationSystem, AgentRecommendation
...
class EnhancedAgentProcessor:
    ...
    def process_file_with_agents(self, file_path: str, skip_questionnaire: bool = False) -> Dict:
        ...
        analysis_data = self.normalization_layer.process_file(file_path)
        ...
        # 7. Ejecutar agentes recomendados
...
def main():
    ...
    if len(sys.argv) < 2:
        console.print("❌ Uso: python enhanced_agent_processor.py <archivo> [--skip-questionnaire]")
        console.print("   Ejemplo: python enhanced_agent_processor.py testastra.xlsx --skip-questionnaire")
        return
